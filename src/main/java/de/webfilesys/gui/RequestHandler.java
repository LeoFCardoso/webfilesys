...
public abstract class RequestHandler {
	...
	public RequestHandler(HttpServletRequest req, HttpServletResponse resp, HttpSession session,
			PrintWriter output) {
		this.req = req;
	 ...
	 * 
	 * Leonardo - this should allways return false, as we're using parameters on server side xsl to handle
	 * context paths others than "/webfilesys"
	 * 
